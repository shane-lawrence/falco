...
k8s_audit_filter_check::k8s_audit_filter_check()
{
...

	{
		...
		m_aliases = {
			...
			{"ka.req.sec_ctx.supplemental_groups.within", {"/requestObject/spec/securityContext/supplementalGroups"_json_pointer, check_supplemental_groups_within, a::IDX_REQUIRED, a::IDX_KEY}},
			...
			{"ka.req.volume.all_flexvolume_drivers", {"/requestObject/spec/volumes"_json_pointer, check_flexvolume_vols, a::IDX_REQUIRED, a::IDX_KEY}},
